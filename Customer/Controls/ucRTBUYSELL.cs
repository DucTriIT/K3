...
namespace GoldRT
{
    public partial class ucRTBUYSELL : UserControl
    {
        ...
        public ucRTBUYSELL(string _BillCode)
        {
            InitializeComponent();
            ...
            try
            {
                ...
                if (strID == "")
                {
                    ds = clsCommon.ExecuteDatasetSP("[TRN_RT_BUYSELL_Ins]",
                            ...
                            txtDebitAmount.EditValue.ToString() == "" ? "0" : txtDebitAmount.EditValue.ToString(),chkCatGia.Checked?"1":"0");
                }
                else
                {
        ...
        private void ucRTBUYSELL_Load(object sender, EventArgs e)
        {
