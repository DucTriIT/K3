...
namespace SuperX.Report.Reports {
    ...
    public class rptTillInOut : ReportClass {
    ...
    public class CachedrptTillInOut : Component, ICachedReport {
        
        public CachedrptTillInOut() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            rptTillInOut rpt = new rptTillInOut();
            rpt.Site = this.Site;
            return rpt;
        }
