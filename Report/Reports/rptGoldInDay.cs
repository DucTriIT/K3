...
namespace SuperX.Report.Reports {
    ...
    public class rptGoldInDay : ReportClass {
    ...
    public class CachedrptGoldInDay : Component, ICachedReport {
        
        public CachedrptGoldInDay() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            rptGoldInDay rpt = new rptGoldInDay();
            rpt.Site = this.Site;
            return rpt;
        }
