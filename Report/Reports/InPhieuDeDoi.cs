...
namespace SuperX.Report.Reports {
    ...
    public class InPhieuDeDoi : ReportClass {
    ...
    public class CachedInPhieuDeDoi : Component, ICachedReport {
        
        public CachedInPhieuDeDoi() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            InPhieuDeDoi rpt = new InPhieuDeDoi();
            rpt.Site = this.Site;
            return rpt;
        }
