...
namespace GoldRT
{
    public partial class frmNgayLe : Form
    {
        ...
        private void fn_GetFocusedRowValue()
        {
            ...
            {
                strID = grdDanhSach.GetFocusedRowCellValue("NgayLe").ToString();
        ...
        public void fn_LoadDataToGrid()
        {
            ...
            try
            {
                ds = clsCommon.ExecuteDatasetSP("[T_NgayLe_Lst]", "", "");
        ...
        {
            frmOptionNgayLe frm = new frmOptionNgayLe(this, "");
            frm.ShowDialog();
        ...
        private void btnSua_Click(object sender, EventArgs e)
        {
            ...
            frmOptionNgayLe frm = new frmOptionNgayLe(this, strID);
            frm.ShowDialog();
        }
        ...
        private void btnXoa_Click(object sender, EventArgs e)
        {
            ...
            if (ThongBao.Show("Thông báo", "Bạn có chắc là muốn xoá thông tin này?", "Có", "Không", ICon.QuestionMark) == DialogResult.OK)
            {
                ...
                try
                {
                    ds = clsCommon.ExecuteDatasetSP("[T_NGAYLE_Del]", strID);
